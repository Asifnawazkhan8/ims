            ...
            <div class="form-row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" name="customer" type="text" value="{{ isset($customer) ? $customer->name : '' }}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="small mb-1" for="inputFirstName">Customer Email</label>
                        <input class="form-control py-4" name="email" type="text" value="{{ isset($customer) ? $customer->email : '' }}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="small mb-1" for="inputLastName">Company</label>
                        <input class="form-control py-4" name="company" type="text" value="{{ isset($customer) ? $customer->company : '' }}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="small mb-1" for="inputLastName">Address</label>
                        <input class="form-control py-4" name="address" type="text" value="{{ isset($customer) ? $customer->address : '' }}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" name="item" type="text" value="{{ isset($product) ? $product->category : '' }}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="small mb-1" for="inputLastName">Product Name</label>
                        <input class="form-control py-4" name="name" type="text" value="{{ isset($product) ? $product->name : '' }}" />
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" name="unit_price" type="text" value="{{ isset($product) ? $product->unit_price : '' }}" />
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" name="quantity" type="text" value="{{ isset($product) ? $order->quantity : '' }}" />
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" name="total" type="text" value="{{ isset($product) ? $product->unit_price * $order->quantity : '' }}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
